...
use rayonetta::texture::{CheckerTexture, ImageTexture};
...
fn checkered_spheres() {
    ...
    world.add(Arc::new(Sphere::new(Point3::new(0.0,-10.0, 0.0), 10.0, material.clone())));
    world.add(Arc::new(Sphere::new(Point3::new(0.0, 10.0, 0.0), 10.0, material.clone())));
...
fn earth() {
    let earth_texture = Arc::new(ImageTexture::from_image("assets/earthmap.jpg"));
    ...
    let vfov = 20.0;
    let lookfrom = Point3::new(12.0, 1.0, 0.0);
    let lookat = Point3::new(0.0, 0.0, 0.0);
    let vup = Vec3::new(0.0, 1.0, 0.0);
